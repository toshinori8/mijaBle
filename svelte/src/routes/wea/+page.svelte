      ...
      <div class="flex justify-between">
        ...
        <div class="h-24 w-24 ">
      	...
      	<div class="flex justify-between mt-12">
				...
				<!-- {#if checkTimestampDays(day.dt, 1) == false}
						<div class="flex flex-col items-center">
							<span class="font-semibold text-lg lcd">{day.temp.day.toFixed(0)}°C</span>
							<img alt="" src="http://openweathermap.org/img/wn/{day.weather[0].icon}.png" />	
							<span class="font-semibold mt-1 text-sm lcd">{day.dt}</span>
							<span class="text-xs font-semibold text-gray-400 lcd">PM</span>
						</div>
					{/if} -->
...
<!-- 
				<div class="flex flex-col items-center">
				<span class="font-semibold text-lg lcd">27°C</span>
				<img alt="" />
				<span class="font-semibold mt-1 text-sm lcd">7:00</span>
				<span class="text-xs font-semibold text-gray-400 lcd">PM</span>
				</div>
			 -->
